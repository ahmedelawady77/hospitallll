                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select name="section_id" class="form-control SlectBox">
                                        @foreach($sections as $section)
                                            ...
                                            <!-- اول جزء اني هجيب القسم معايا لكن اي دي بس مش اسم الجزء التاني بقوله لو ساوا القسم الي الدكتور كان مختاره ف اعملي عليه سيليكت و تالت جزء بظهر الاسامي بناء غلي اول جزء-->
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
