...
@section('title')
{{trans('Dashboard/doctors_trans.Doctortitle')}} 
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/doctors_trans.Doctortitle')}}</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0"> /ALL DOCTORS / كل الاطباء</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            @foreach($doctors as $doctor)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <img src="{{Url::asset('Dashboard/img/doctors/doc.jpg')}}" height="50px"
                                                 width="50px" alt="">
                                        @endif
                                    </td>
                                    <td>{{ $doctor->email }}</td>
